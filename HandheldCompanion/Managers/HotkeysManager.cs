...
public class HotkeysManager : IManager
{
    ...
    {
        // initialize path
        ManagerPath = Path.Combine(System.IO.Path.Combine(System.Environment.GetFolderPath(System.Environment.SpecialFolder.ApplicationData), "HandheldCompanion"), "hotkeys");
    ...
    public void SerializeHotkey(Hotkey hotkey)
    {
        ...
        hotkey.Version = new Version("1.0.0.0");
