...
namespace HandheldCompanion.Managers
{
    public class PowerProfileManager : IManager
    {
        ...
        {
            // initialize path
            ManagerPath = Path.Combine(System.IO.Path.Combine(System.Environment.GetFolderPath(System.Environment.SpecialFolder.ApplicationData), "HandheldCompanion"), "powerprofiles");
