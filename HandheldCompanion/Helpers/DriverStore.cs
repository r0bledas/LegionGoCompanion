...
namespace HandheldCompanion.Helpers
{
    ...
    {
        private static string DriversPath = Path.Combine(System.IO.Path.Combine(System.Environment.GetFolderPath(System.Environment.SpecialFolder.ApplicationData), "HandheldCompanion"), "drivers.json");
