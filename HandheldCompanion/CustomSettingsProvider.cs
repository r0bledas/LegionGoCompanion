...
namespace HandheldCompanion
{
    public class CustomSettingsProvider : SettingsProvider
    {
        ...
        public override void Initialize(string name, NameValueCollection config)
        {
            ...
            UserConfigPath = Path.Combine(System.IO.Path.Combine(System.Environment.GetFolderPath(System.Environment.SpecialFolder.ApplicationData), "HandheldCompanion"), UserConfigFileName);
        }
