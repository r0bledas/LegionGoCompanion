...
namespace HandheldCompanion.Sensors
{
    public class IMUCalibration
    {
        ...
        public static string CalibrationPath = Path.Combine(System.IO.Path.Combine(System.Environment.GetFolderPath(System.Environment.SpecialFolder.ApplicationData), "HandheldCompanion"), "calibration.json");
        ...
        {
            // initialize path
            CalibrationPath = Path.Combine(System.IO.Path.Combine(System.Environment.GetFolderPath(System.Environment.SpecialFolder.ApplicationData), "HandheldCompanion"), "calibration.json");
